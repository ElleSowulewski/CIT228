...
fig, ax = plt.subplots()
ax.scatter(days, tempsJune, label="June", c=tempsJune, cmap=plt.cm.Oranges)
ax.scatter(days, tempsJuly,  label="July", c=tempsJuly, cmap=plt.cm.Oranges)
ax.scatter(days, tempsJan,  label="January", c=tempsJan, cmap=plt.cm.Purples)
ax.scatter(days, tempsFeb,  label="Febuary", c=tempsFeb, cmap=plt.cm.Purples)
#plt.legend(loc="best", ncol=2, fontsize=8)

ax.set_title("Temperature Comparison", fontsize=24)
plt.suptitle("Jan-Feb vs Jun-July")
